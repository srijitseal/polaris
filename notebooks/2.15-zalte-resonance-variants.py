...
def main(
    ...
    summary = consistency_df.groupby("endpoint")[
    ...
    fig.suptitle("Prediction CV Across Resonance Structures by Endpoint", fontsize=14, y=1.02)
    fig.tight_layout()
    ...
    sns.scatterplot(data=consistency_df, x="max_fp_dist", y="resonance_range", hue="endpoint", alpha=0.6, ax=ax)
